...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- Core -->
		<title>Welcome to Triadi Prabowo's Website</title>
	...
	<!-- End Header -->
		...
		<section class="tp-slider-wrapper">
			...
			<section class="tp-slider-content">
				...
				<section class="tp-slider-content-inner">
					<h1><span class="tp-icon fa-file"></span> tpScroll Bootstrap</h1>
					<p>Download latest version of cool 'tpScroll' jQuery plugin & Bootstrap for your projects!<br /> Version 1.0 - Initial Build</p>
		...
		<section class="tp-content-wrapper">
			<section class="tp-content-inner">
                ...
                <p>
	                My name is Triadi Prabowo, the man driven by an unbridled and relentless passion for web design. I am born 
	                ...
	                next high-end job around the top companies.</p>
	                      
	                <h4>The Designer</h4>
	                <p></span> No matter how many times I should try to get there as soon as I entered the web design world, I feel my blood boiling in my vein and I thought at the time: "This is my world!". 
	                ...
	                my design is invisible but really eyed-candy. My family supported me for what I am doing and I keep practicing and improving my experience in web design world.</p>
	                    
	                <h4>The Gamer</h4>
	                <p></span> I'm starting playing games since my childhood, games is really helping me improving my english even though my english still not that
	                ...
	                Legend of Dragoon helped me to improved my logic.</p>
	                   
	                <h4>How It All Began</h4>
	                <p></span> Born in Jakarta, Indonesia (January 04, 1994), I am indulged my passion for computing from a young age. I thought at the time “So as a little nerdy kid 
