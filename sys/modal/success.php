...
if($_GET['res'] == 'contact') { ?>
	<section class="tp-modal-wrapper medium">
		...
		<div class="tp-modal-closeicon hvr-buzz-out" ng-click="refreshClose()"><span class="tp-icon fa-times"></span></div>
		...
		<section class="tp-modal-inner">
			<section class="tp-modal-content">
				...
				<div class="tp-modal-submit right">
					<a href="javascript:void(0)" class="tp-button" ng-click="refreshClose()"><span class="tp-icon fa-check"></span> OK</a>
				</div>
			</section>
		</section>
	</section>
